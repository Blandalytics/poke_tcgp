...
st.text('Enter a Win Rate and initial number of points and this app will simulate thousands of seasons at that win rate and initial points value to determine how many games need to be played to reach Master Ball rank. Seasons take into consideration win streaks and rank-specific loss penalties.')
